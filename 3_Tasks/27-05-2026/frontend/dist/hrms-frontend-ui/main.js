...
var routes = [
  {
    path: "login",
    loadComponent: () => import("./chunk-4RS64XB3.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    loadComponent: () => import("./chunk-A2RJSO6R.js").then((m) => m.MainLayoutComponent),
    ...
    children: [
      ...
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-DBGY4KDS.js").then((m) => m.DashboardComponent)
      },
      {
        path: "employees",
        loadComponent: () => import("./chunk-OU64C22I.js").then((m) => m.EmployeeListComponent)
      },
      {
        path: "payroll",
        loadComponent: () => import("./chunk-2GI77K7I.js").then((m) => m.PayrollCalculatorComponent)
      },
      {
        path: "attendance",
        loadComponent: () => import("./chunk-PT5KDECG.js").then((m) => m.AttendanceComponent)
      },
      {
        path: "leave",
        loadComponent: () => import("./chunk-GFNEJRYB.js").then((m) => m.LeaveManagementComponent)
      },
      {
        path: "assets",
        loadComponent: () => import("./chunk-QJXGZNDN.js").then((m) => m.AssetManagementComponent)
      },
      {
        path: "tenants",
        loadComponent: () => import("./chunk-6Y6RXGHK.js").then((m) => m.TenantManagementComponent)
      }
    ]
  },
  {
