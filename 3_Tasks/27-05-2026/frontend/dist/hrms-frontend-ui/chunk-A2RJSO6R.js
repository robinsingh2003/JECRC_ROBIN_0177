...
var _c06 = (a0, a1) => ({ "fixed inset-y-0 left-0": true, "-translate-x-full lg:translate-x-0": a0, "translate-x-0": a1 });
function MainLayoutComponent_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 35);
    \u0275\u0275listener("click", function MainLayoutComponent_Conditional_1_Template_div_click_0_listener() {
      \u0275\u0275restoreView(_r2);
...
function MainLayoutComponent_For_14_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "a", 37);
    \u0275\u0275listener("click", function MainLayoutComponent_For_14_Conditional_0_Template_a_click_0_listener() {
      \u0275\u0275restoreView(_r4);
...
function MainLayoutComponent_For_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, MainLayoutComponent_For_14_Conditional_0_Template, 5, 3, "a", 36);
  }
  if (rf & 2) {
    const item_r5 = ctx.$implicit;
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275conditional(ctx_r2.authService.hasRole(item_r5.roles) ? 0 : -1);
  }
}
function MainLayoutComponent_For_48_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function MainLayoutComponent_For_48_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 40);
    \u0275\u0275listener("click", function MainLayoutComponent_For_48_Template_button_click_0_listener() {
      const t_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.switchTenant(t_r7.id));
    });
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, MainLayoutComponent_For_48_Conditional_5_Template, 2, 0, "span", 43);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", t_r7.name, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(t_r7.id === ctx_r2.getActiveTenantId() ? 5 : -1);
  }
}
var MainLayoutComponent = class _MainLayoutComponent {
  ...
  // Edge case fix: mobile sidebar toggle state
  sidebarOpen = false;
  navItems = [
    { label: "Dashboard", route: "/dashboard", icon: "dashboard", roles: ["Employee", "HR", "PayrollAdmin"] },
    { label: "Employees", route: "/employees", icon: "people", roles: ["HR", "SuperAdmin"] },
    { label: "Payroll Engine", route: "/payroll", icon: "payments", roles: ["PayrollAdmin", "HR", "SuperAdmin"] },
    { label: "Attendance", route: "/attendance", icon: "fingerprint", roles: ["HR", "Employee", "SuperAdmin"] },
    { label: "Leave Management", route: "/leave", icon: "event_busy", roles: ["HR", "Employee", "Manager", "SuperAdmin"] },
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MainLayoutComponent, selectors: [["app-main-layout"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 57, vars: 11, consts: [["tenantMenu", "matMenu"], [1, "h-screen", "w-screen", "flex", "overflow-hidden", "bg-slate-950", "text-slate-100"], [1, "fixed", "inset-0", "bg-slate-950/60", "backdrop-blur-sm", "z-30", "lg:hidden"], [1, "w-64", "border-r", "border-slate-800", "bg-slate-900/60", "backdrop-blur-md", "flex", "flex-col", "z-40", "transition-transform", "duration-300", "ease-in-out", 3, "ngClass"], [1, "h-16", "flex", "items-center", "justify-between", "px-6", "border-b", "border-slate-800"], [1, "flex", "items-center", "space-x-2"], [1, "material-icons", "text-brand-500", "text-3xl"], [1, "text-xl", "font-bold", "tracking-wider", "bg-gradient-to-r", "from-white", "via-slate-200", "to-slate-400", "bg-clip-text", "text-transparent"], [1, "lg:hidden", "text-slate-400", "hover:text-white", "transition-colors", "p-1", 3, "click"], [1, "material-icons"], [1, "flex-1", "px-4", "py-6", "space-y-2", "overflow-y-auto"], [1, "p-4", "border-t", "border-slate-800", "bg-slate-900/30"], [1, "flex", "items-center", "space-x-3", "p-2", "rounded-xl", "bg-slate-800/40", "border", "border-slate-800"], [1, "h-10", "w-10", "rounded-lg", "bg-brand-500/10", "border", "border-brand-500/30", "flex", "items-center", "justify-center", "text-brand-400", "font-bold"], [1, "flex-1", "min-w-0"], [1, "text-xs", "font-semibold", "text-slate-200", "truncate"], [1, "text-[10px]", "text-slate-400", "font-medium", "tracking-wide", "uppercase"], [1, "flex-1", "flex", "flex-col", "min-w-0", "overflow-hidden", "lg:ml-64"], [1, "h-16", "border-b", "border-slate-800", "bg-slate-950/80", "backdrop-blur-md", "flex", "items-center", "justify-between", "px-4", "sm:px-8", "z-10"], [1, "flex", "items-center", "space-x-4"], ["id", "sidebarToggleBtn", 1, "lg:hidden", "text-slate-400", "hover:text-white", "transition-colors", "p-1.5", "rounded-lg", "hover:bg-slate-800", 3, "click"], [1, "text-sm", "text-slate-400", "font-medium", "uppercase", "tracking-wider", "hidden", "sm:block"], [1, "flex", "items-center", "space-x-3", "sm:space-x-6"], [1, "text-xs", "text-slate-400", "font-medium", "hidden", "md:block"], ["mat-button", "", 1, "bg-slate-900/80", "hover:bg-slate-800", "border", "border-slate-800", "px-3", "sm:px-4", "py-1.5", "rounded-xl", "text-xs", "font-semibold", "text-brand-400", "flex", "items-center", "transition-all", "duration-200", 3, "matMenuTriggerFor"], [1, "material-icons", "text-sm", "mr-1", "sm:mr-2", "text-brand-500"], [1, "hidden", "sm:inline"], [1, "sm:hidden"], [1, "material-icons", "text-sm", "ml-1", "text-slate-500"], [1, "bg-slate-900", "border", "border-slate-800", "text-slate-200", "rounded-2xl", "shadow-2xl"], ["mat-menu-item", "", 1, "hover:bg-slate-800", "flex", "items-center", "justify-between", "py-2.5", "px-4", "text-xs", "font-medium", "text-slate-300"], [1, "h-6", "w-px", "bg-slate-800", "hidden", "sm:block"], ["id", "logoutBtn", 1, "flex", "items-center", "text-xs", "font-semibold", "text-slate-400", "hover:text-red-400", "transition-colors", "duration-200", "py-1.5", "px-2", "sm:px-3", "rounded-lg", "hover:bg-red-500/5", "border", "border-transparent", "hover:border-red-500/10", 3, "click"], [1, "material-icons", "text-sm", "sm:mr-1.5"], [1, "flex-1", "overflow-y-auto", "bg-slate-950", "p-4", "sm:p-8"], [1, "fixed", "inset-0", "bg-slate-950/60", "backdrop-blur-sm", "z-30", "lg:hidden", 3, "click"], ["routerLinkActive", "nav-link-active", 1, "flex", "items-center", "px-4", "py-3", "text-slate-400", "hover:text-slate-200", "hover:bg-slate-800/50", "rounded-xl", "transition-all", "duration-200", "group", "border", "border-transparent", 3, "routerLink"], ["routerLinkActive", "nav-link-active", 1, "flex", "items-center", "px-4", "py-3", "text-slate-400", "hover:text-slate-200", "hover:bg-slate-800/50", "rounded-xl", "transition-all", "duration-200", "group", "border", "border-transparent", 3, "click", "routerLink"], [1, "material-icons", "mr-3", "group-hover:scale-110", "transition-transform"], [1, "text-sm", "font-medium"], ["mat-menu-item", "", 1, "hover:bg-slate-800", "flex", "items-center", "justify-between", "py-2.5", "px-4", "text-xs", "font-medium", "text-slate-300", 3, "click"], [1, "flex", "items-center"], [1, "material-icons", "mr-2", "text-sm", "text-slate-400"], [1, "material-icons", "text-brand-500", "text-xs", "ml-4"]], template: function MainLayoutComponent_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275elementStart(0, "div", 1);
      \u0275\u0275template(1, MainLayoutComponent_Conditional_1_Template, 1, 0, "div", 2);
      \u0275\u0275elementStart(2, "aside", 3)(3, "div", 4)(4, "div", 5)(5, "span", 6);
      \u0275\u0275text(6, "hub");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "span", 7);
      \u0275\u0275text(8, " CAPGEMINI HRMS ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "button", 8);
      \u0275\u0275listener("click", function MainLayoutComponent_Template_button_click_9_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.closeSidebar());
      });
      \u0275\u0275elementStart(10, "span", 9);
      \u0275\u0275text(11, "close");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(12, "nav", 10);
      \u0275\u0275repeaterCreate(13, MainLayoutComponent_For_14_Template, 1, 1, null, null, _forTrack0);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(23);
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(24, "div", 17)(25, "header", 18)(26, "div", 19)(27, "button", 20);
      \u0275\u0275listener("click", function MainLayoutComponent_Template_button_click_27_listener() {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275text(31, "Enterprise HR Portal");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(32, "div", 22)(33, "div", 5)(34, "span", 23);
      \u0275\u0275text(35, "Tenant Context:");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(45, "mat-menu", 29, 0);
      \u0275\u0275repeaterCreate(47, MainLayoutComponent_For_48_Template, 6, 2, "button", 30, _forTrack1);
      \u0275\u0275elementEnd()();
      \u0275\u0275element(49, "div", 31);
      \u0275\u0275elementStart(50, "button", 32);
      \u0275\u0275listener("click", function MainLayoutComponent_Template_button_click_50_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.handleLogout());
      });
      ...
      \u0275\u0275text(54, "Sign Out");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(55, "main", 34);
      \u0275\u0275element(56, "router-outlet");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      const tenantMenu_r8 = \u0275\u0275reference(46);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.sidebarOpen ? 1 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(8, _c06, !ctx.sidebarOpen, ctx.sidebarOpen));
      \u0275\u0275advance(11);
      \u0275\u0275repeater(ctx.navItems);
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate1(" ", ctx.getSessionRole().substring(0, 2).toUpperCase(), " ");
      \u0275\u0275advance(3);
      \u0275\u0275textInterpolate(ctx.getSessionEmail());
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.getSessionRole());
      \u0275\u0275advance(13);
      \u0275\u0275property("matMenuTriggerFor", tenantMenu_r8);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.getActiveTenantName());
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.tenantService.getActiveTenant().countryCode);
      \u0275\u0275advance(5);
      \u0275\u0275repeater(ctx.tenantService.tenants);
    }
  }, dependencies: [CommonModule, NgClass, RouterModule, RouterOutlet, RouterLink, RouterLinkActive, MatMenuModule, MatMenu, MatMenuItem, MatMenuTrigger, MatButtonModule, MatButton, MatIconModule], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MainLayoutComponent, { className: "MainLayoutComponent", filePath: "src\\app\\layouts\\main-layout\\main-layout.component.ts", lineNumber: 23 });
})();
export {
  MainLayoutComponent
};
//# sourceMappingURL=chunk-A2RJSO6R.js.map
